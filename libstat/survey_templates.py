        ...
        sections=[
            ...
            Section(title=u"Bestånd – nyförvärv",
                    groups=[
                        ...
                        Group(rows=[
                            Row(cells=[
                                Cell(variable_key=u"Barn01", types=['required', 'integer'])]),
                            Row(cells=[
                                Cell(variable_key=u"Barn02", types=['required', 'integer'])]),
                            Row(cells=[
                                Cell(variable_key=u"Barn03", types=['required', 'integer'])]),
                            Row(cells=[
                                Cell(variable_key=u"HCG04", types=['required', 'integer'])]),
                            Row(cells=[
                                Cell(variable_key=u"Ref05", types=['required', 'integer'])]),
                            Row(cells=[
                                Cell(variable_key=u"LasnedBest01", types=['required', 'integer'])]),
                            Row(cells=[
                                Cell(variable_key=u"LasnedUtlan01", types=['required', 'integer'])])]),
                        Group(rows=[
                            Row(cells=[
