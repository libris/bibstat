                    ...
                    Group(
                        ...
                        rows=[
                            ...
                            Row(
                                ...
                                explanation="",
                                cells=[
                                    Cell(variable_key=u"Bestand111", types=['sum', 'integer'],
                                         sum_siblings=['Bestand101', 'Bestand102', 'Bestand103', 'Bestand104',
                                                       'Bestand105', 'Bestand106', 'Bestand107', 'Bestand108',
                                                       'Bestand109', 'Bestand110', 'Bestand112', 'Bestand113']),
                                    Cell(variable_key=u"Bestand211", types=['sum', 'integer'],
                                         sum_siblings=['Bestand201', 'Bestand202', 'Bestand203', 'Bestand204',
                                                       'Bestand205', 'Bestand206', 'Bestand207', 'Bestand208',
                                                       'Bestand209', 'Bestand210', 'Bestand212', 'Bestand213']),
                                    Cell(variable_key=u"Bestand311", types=['sum', 'integer'],
                                         sum_siblings=['Bestand301', 'Bestand302', 'Bestand303', 'Bestand304',
                                                       'Bestand305', 'Bestand306', 'Bestand307', 'Bestand308',
                                                       'Bestand310', 'Bestand312', 'Bestand313']),
                                ]
                            ),
                            Row(
                                ...
                                explanation="",
                                cells=[
                                    Cell(variable_key=u"Bestand112", types=['sum', 'integer'],
                                         sum_siblings=['Bestand101', 'Bestand102', 'Bestand103', 'Bestand104',
                                                       'Bestand105', 'Bestand106', 'Bestand107', 'Bestand108',
                                                       'Bestand109', 'Bestand110', 'Bestand111', 'Bestand113']),
                                    Cell(variable_key=u"Bestand212", types=['sum', 'integer'],
                                         sum_siblings=['Bestand201', 'Bestand202', 'Bestand203', 'Bestand204',
                                                       'Bestand205', 'Bestand206', 'Bestand207', 'Bestand208',
                                                       'Bestand209', 'Bestand210', 'Bestand211', 'Bestand213']),
                                    Cell(variable_key=u"Bestand312", types=['sum', 'integer'],
                                         sum_siblings=['Bestand301', 'Bestand302', 'Bestand303', 'Bestand304',
                                                       'Bestand305', 'Bestand306', 'Bestand307', 'Bestand308',
                                                       'Bestand310', 'Bestand311', 'Bestand313']),
                                ]
                            ),
                            Row(
                                ...
                                explanation="",
                                cells=[
                                    Cell(variable_key=u"Bestand113", types=['sum', 'integer'],
                                         sum_siblings=['Bestand101', 'Bestand102', 'Bestand103', 'Bestand104',
                                                       'Bestand105', 'Bestand106', 'Bestand107', 'Bestand108',
                                                       'Bestand109', 'Bestand110', 'Bestand111', 'Bestand112']),
                                    Cell(variable_key=u"Bestand213", types=['sum', 'integer'],
                                         sum_siblings=['Bestand201', 'Bestand202', 'Bestand203', 'Bestand204',
                                                       'Bestand205', 'Bestand206', 'Bestand207', 'Bestand208',
                                                       'Bestand209', 'Bestand210', 'Bestand211', 'Bestand212']),
                                    Cell(variable_key=u"Bestand313", types=['sum', 'integer'],
                                         sum_siblings=['Bestand301', 'Bestand302', 'Bestand303', 'Bestand304',
                                                       'Bestand305', 'Bestand306', 'Bestand307', 'Bestand308',
                                                       'Bestand310', 'Bestand311', 'Bestand312']),
                                ]
                            ),
                            Row(
