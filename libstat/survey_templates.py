                        ...
                        Group(rows=[
                            ...
                            Row(cells=[
                                Cell(variable_key=u"Bestand199", types=['integer'],
                                     sum_of=['Bestand101', 'Bestand102', 'Bestand103',
                                ...
                                Cell(variable_key=u"Bestand299", types=['integer'],
                                     sum_of=['Bestand201', 'Bestand202', 'Bestand203',
                                ...
                                Cell(variable_key=u"Bestand399", types=['integer'],
                                     sum_of=['Bestand301', 'Bestand302', 'Bestand303',
