    ...
    return ReportTemplate(groups=[
        ...
        Group(title=u"Utlån fysiskt bestånd",
              ...
              rows=[
                  ...
                  Row(description=u"Antal lån e-böcker med skriven text per invånare",
                      computation=(lambda a, b: a / b),
                      variable_keys=[u"Utlan301", u"Population01"]),
                  Row(description=u"Antal lån e-böcker med skriven text per person i målgruppen",
                      computation=(lambda a, b: a / b),
...
def report_template_2014_without_target_group_calculations():
    return ReportTemplate(groups=[
        Group(title=u"Organisation",
              rows=[
                  Row(variable_key=u"BemanService01"),
