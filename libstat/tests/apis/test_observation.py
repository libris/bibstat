...
class ObservationApiTest(MongoTestCase):
    ...
    def test_response_should_contain_context(self):
        ...
        self.assertEqual(data["@context"]["@vocab"], "{}/def/terms/".format(settings.API_BASE_URL)),
        self.assertEqual(data["@context"]["@base"], "{}/data/".format(settings.API_BASE_URL))
    ...
    def test_should_return_one_observation(self):
        ...
        self.assertEqual(data["library"]["@id"], "{}/library/{}".format(settings.BIBDB_BASE_URL, obs.sigel))
