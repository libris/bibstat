...
class ImportVariablesTest(MongoTestCase):
    ...
    def test_should_update_public_lib_variables(self):
        ...
        self.assertEqual(Variable.objects.filter(key="Folk52")[0].target_groups, ["folkbib"])
        ...
        self.assertEqual(Variable.objects.filter(key="Folk52")[0].target_groups, ["skolbib"])
    ...
    def test_should_update_research_lib_variables(self):
        ...
        self.assertEqual(len(Variable.objects.all()), 163)
        # Check target_group before
        self.assertEqual(Variable.objects.filter(key="Forsk111")[0].target_groups, ["specbib"])
        ...
        self.assertEqual(len(Variable.objects.all()), 163)
        # Check target_group after
        self.assertEqual(Variable.objects.filter(key="Forsk111")[0].target_groups, ["sjukbib"])
    ...
    def test_should_update_hospital_lib_variables(self):
        ...
        self.assertEqual(len(Variable.objects.all()), 151)
        # Check target_group before
        self.assertEqual(Variable.objects.filter(key="Sjukhus23")[0].target_groups, ["sjukbib"])
    ...
    def test_should_update_school_lib_variables(self):
        ...
        self.assertEqual(len(Variable.objects.all()), 139)
        # Check target_group before
        self.assertEqual(Variable.objects.filter(key="Skol5")[0].target_groups, ["skolbib"])
        ...
        self.assertEqual(len(Variable.objects.all()), 139)
        # Check target_group after
        self.assertEqual(Variable.objects.filter(key="Skol5")[0].target_groups, ["specbib"])
