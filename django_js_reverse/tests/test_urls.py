...
basic_patterns = [
    ...
    url(r"^test_unicode_url_name/$", dummy_view, name="test_unicode_url_name"),
    url(
...
urlexclude = [
    url(r"^test_exclude_namespace/$", dummy_view, name="test_exclude_namespace_url1")
]
...
# test namespace
pattern_ns_1 = [url(r"", django_include(basic_patterns))]

pattern_ns_2 = [url(r"", django_include(basic_patterns))]

pattern_ns = [url(r"", django_include(basic_patterns))]

pattern_nested_ns = [url(r"^ns1/", include(pattern_ns_1, namespace="ns1"))]

pattern_dubble_nested2_ns = [url(r"^ns1/", include(pattern_ns_1, namespace="ns1"))]
